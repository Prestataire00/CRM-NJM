...
const {
    ...
    VerticalAlign, ImageRun, Header, Footer,
    SectionType, convertMillimetersToTwip, HeadingLevel,
...
function bold(text, opts = {}) {
    return new TextRun({ text, bold: true, size: opts.size || 18, font: 'Arial', color: opts.color || DARK_GRAY, ...opts });
}
function normal(text, opts = {}) {
    return new TextRun({ text, size: opts.size || 18, font: 'Arial', color: opts.color || DARK_GRAY, ...opts });
}
function orangeBold(text, opts = {}) {
    return new TextRun({ text, bold: true, size: opts.size || 18, font: 'Arial', color: ORANGE, ...opts });
}
...
function njmHeader() {
    return [
        // Logo + activites en parallele (logo a gauche, texte a droite)
        new Paragraph({
            children: [
                new ImageRun({ data: logoBuffer, transformation: { width: 130, height: 75 }, type: 'png' }),
            ],
        }),
        new Paragraph({
            ...
            spacing: { before: 0 },
            children: [
                bold('MARKETING', { size: 13, color: ORANGE }),
            ],
        }),
        new Paragraph({
            alignment: AlignmentType.RIGHT,
            children: [bold('WEB MARKETING', { size: 13, color: ORANGE })],
        }),
        new Paragraph({
            alignment: AlignmentType.RIGHT,
            children: [bold('COMMERCIAL', { size: 13, color: ORANGE })],
        }),
        new Paragraph({
            alignment: AlignmentType.RIGHT,
            children: [bold('COMMUNICATION', { size: 13, color: ORANGE })],
        }),
        new Paragraph({
            alignment: AlignmentType.RIGHT,
            spacing: { after: 200 },
            children: [bold('COACHING', { size: 13, color: ORANGE })],
        }),
    ];
}
    ...
    return new Footer({
        children: [
            new Paragraph({
                ...
                spacing: { before: 100 },
                children: [
                    bold('NJM Conseil - NATHALIE JOULIE MORAND - LE CASSAN - 12330 CLAIRVAUX D\'AVEYRON - 06 88 10 40 67 - njm.conseil@orange.fr', { size: 11, color: PURPLE }),
                ],
            }),
            new Paragraph({
                alignment: AlignmentType.CENTER,
                children: [
                    normal('www.njm-conseil.fr SAS NJM Conseil au capital social de 3 000\u20AC N\u00B0RCS Rodez 534 935 473 NAF 7022Z N\u00B0 Activit\u00E9 : 73120063512', { size: 10, color: GRAY }),
                ],
            }),
            new Paragraph({
                alignment: AlignmentType.CENTER,
                children: [
                    normal('Qualiopi C2-5 V2 16-11-2020', { size: 10, color: GRAY }),
                ],
            }),
        ],
    });
...
// Bullet avec label orange bold + valeur
function bulletPoint(label, value) {
    return new Paragraph({
        spacing: { after: 40 },
        indent: { left: convertMillimetersToTwip(5) },
        children: [
            new TextRun({ text: '\u25CF ', color: ORANGE, size: 18, font: 'Arial' }),
            orangeBold(label + ' '),
            normal(value),
        ],
    });
...
function articleTitle(text) {
    return new Paragraph({
        ...
        children: [
            new TextRun({
                text, bold: true, underline: { type: UnderlineType.SINGLE },
                size: 18, font: 'Arial', color: DARK_GRAY,
            }),
        ],
    });
}
        ...
        sections: [
            // PAGE 1
            {
                ...
                children: [
                    ...
                    new Paragraph({ spacing: { after: 120 }, children: [normal('Ci-apr\u00E8s d\u00E9sign\u00E9 "l\'organisme de formation", NJM Conseil')] }),

                    new Paragraph({ children: [normal('Et')] }),
                    new Paragraph({ spacing: { after: 80 }, children: [normal('Le client :')] }),
                    ...
                    new Paragraph({ spacing: { after: 120 }, children: [normal('Ci-apr\u00E8s d\u00E9sign\u00E9 "le Client",')] }),
            ...
            // PAGE 2
            {
                ...
                children: [
                    ...
                    new Paragraph({ spacing: { before: 60, after: 40 }, children: [normal('Objectifs :', { underline: { type: UnderlineType.SINGLE } })] }),
                    dashItem('{{objectives}}'),
                    emptyLine(60),
            ...
            // PAGE 3
            {
                ...
                children: [
                    ...
                    new Paragraph({
                        spacing: { after: 200 },
                        alignment: AlignmentType.RIGHT,
                        children: [normal('Fait en double exemplaire, \u00E0 Rodez, le {{signature_date}}')],
                    }),
                    ...
                    new Paragraph({
                        ...
                        children: [
                            normal('{{contact_name}}'),
                            new TextRun({ text: '\t', size: 18, font: 'Arial' }),
                            normal('Nathalie JOULIE MORAND, g\u00E9rante'),
                        ],
                    }),
            ...
            // PAGE 1 : CERTIFICAT DE REALISATION
            {
                ...
                children: [
                    ...
                    new Paragraph({
                        ...
                        alignment: AlignmentType.CENTER,
                        children: [bold('CERTIFICAT DE REALISATION', { size: 26 })],
                    }),

                    new Paragraph({
                        spacing: { after: 60 },
                        children: [normal('Je soussign\u00E9e, Mme Nathalie JOULIE-MORAND, agissant en qualit\u00E9 de directrice de NJM Conseil, formatrice ind\u00E9pendante sous le num\u00E9ro SIRET 534 935 473 000 15 et sous le num\u00E9ro de formateur 73 12 00 635 12 atteste que :')],
                    }),

                    new Paragraph({
                        spacing: { after: 80 },
                        children: [normal('{{learner_name}}, salari\u00E9(e) de l\'entreprise {{company_name}} a suivi la formation {{formation_name}}, qui s\'est d\u00E9roul\u00E9e {{dates}}, pour une dur\u00E9e de {{duration}}h.')],
                    }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Assiduit\u00E9 du stagiaire :')] }),
                    new Paragraph({ spacing: { after: 80 }, children: [normal('Dur\u00E9e effectivement suivie par le/la stagiaire : {{duration}}h, soit un taux de r\u00E9alisation de 100%.')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [normal('Nature de l\'action concourant au d\u00E9veloppement des comp\u00E9tences :')] }),
                    new Paragraph({ indent: { left: convertMillimetersToTwip(5) }, spacing: { after: 20 }, children: [normal('\u2611 Action de formation')] }),
                    new Paragraph({ indent: { left: convertMillimetersToTwip(5) }, spacing: { after: 80 }, children: [normal('\u2610 Bilan de comp\u00E9tences')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [normal('Sans pr\u00E9judice des d\u00E9lais impos\u00E9s par les r\u00E8gles fiscales, comptables ou commerciales, je m\'engage \u00E0 conserver l\'ensemble des pi\u00E8ces justificatives qui ont permis d\'\u00E9tablir le pr\u00E9sent certificat, pendant une dur\u00E9e de 3 ans \u00E0 compter de la fin de l\'ann\u00E9e du dernier paiement.')] }),
                    new Paragraph({ spacing: { after: 120 }, children: [normal('En cas de cofinancement des fonds europ\u00E9ens, la dur\u00E9e de conservation est \u00E9tendue conform\u00E9ment aux obligations conventionnelles sp\u00E9cifiques.')] }),

                    new Paragraph({ spacing: { after: 120 }, alignment: AlignmentType.RIGHT, children: [normal('Fait \u00E0 Rodez, {{signature_date}}')] }),
                    new Paragraph({ spacing: { after: 40 }, alignment: AlignmentType.CENTER, children: [normal('Cachet et signature de la responsable de l\'organisme de formation NJM Conseil')] }),
                    new Paragraph({ alignment: AlignmentType.CENTER, children: [normal('Nathalie JOULIE MORAND')] }),
                ],
            },
            // PAGE 2 : ATTESTATION DE FIN DE FORMATION
            {
                ...
                children: [
                    ...
                    new Paragraph({
                        ...
                        alignment: AlignmentType.CENTER,
                        children: [bold('ATTESTATION DE FIN DE FORMATION', { size: 26, color: ORANGE })],
                    }),
                    new Paragraph({
                        spacing: { after: 120 },
                        alignment: AlignmentType.CENTER,
                        children: [normal('Article .6353-1 du Code du Travail', { size: 16, color: GRAY })],
                    }),
                    ...
                    new Paragraph({ spacing: { after: 60 }, children: [normal('Le salari\u00E9 de l\'entreprise : {{learner_name}} pour {{company_name}}.')] }),
                    new Paragraph({ spacing: { after: 60 }, children: [normal('A suivi dans le cadre d\'une action de formation professionnelle continue, relevant de l\'article L 6313-1 du code du travail, la formation suivante :')] }),
                    ...
                    new Paragraph({ spacing: { after: 20 }, children: [
                        new TextRun({ text: '\u25CF ', size: 18, font: 'Arial', color: DARK_GRAY }),
                        normal('Nature de l\'action (article L.6313-1 du Code du Travail)'),
                    ]}),
                    ...
                    new Paragraph({ spacing: { after: 20 }, children: [
                        new TextRun({ text: '\u25CF ', size: 18, font: 'Arial', color: DARK_GRAY }),
                        normal('Rappel des objectifs p\u00E9dagogiques'),
                    ]}),
                    new Paragraph({ indent: { left: convertMillimetersToTwip(5) }, spacing: { after: 20 }, children: [normal('A l\'issue de la formation, le stagiaire sera en capacit\u00E9 d\' :')] }),
                    new Paragraph({ indent: { left: convertMillimetersToTwip(5) }, spacing: { after: 40 }, children: [normal('{{objectives}}')] }),

                    new Paragraph({ spacing: { after: 20 }, children: [
                        new TextRun({ text: '\u25CF ', size: 18, font: 'Arial', color: DARK_GRAY }),
                        normal('L\'action s\'est d\u00E9roul\u00E9e \u00E0 {{training_location}}, {{dates}},'),
                    ]}),
                    ...
                    new Paragraph({ spacing: { after: 40 }, children: [
                        new TextRun({ text: '\u25CF ', size: 18, font: 'Arial', color: DARK_GRAY }),
                        normal('R\u00E9sultats de l\'\u00E9valuation des acquis au regard des objectifs de la formation :'),
                    ]}),
                    new Paragraph({ indent: { left: convertMillimetersToTwip(5) }, spacing: { after: 80 }, children: [normal('{{objectives}}')] }),

                    new Paragraph({ spacing: { after: 120 }, alignment: AlignmentType.RIGHT, children: [normal('Fait \u00E0 Rodez, le {{signature_date}}')] }),
                    new Paragraph({ alignment: AlignmentType.CENTER, children: [normal('Nathalie JOULIE MORAND, g\u00E9rante')] }),
                    new Paragraph({ alignment: AlignmentType.CENTER, children: [normal('NJM Conseil')] }),
                ],
            },
        ],
    });
...
async function generateFeuillePresence() {
    ...
    function headerCell(text, width) {
        return new TableCell({
            ...
            children: [new Paragraph({ children: [bold(text, { size: 16 })] })],
        });
    }
    function learnerRow(idx) {
    ...
    const table = new Table({
        ...
        rows: [
            new TableRow({
                ...
                children: [
                    headerCell('NOM et pr\u00E9nom de\nl\'apprenant', colW[0]),
                    headerCell('Matin\n9h00 \u00E0 12h30', colW[1]),
                    headerCell('Apr\u00E8s-midi\n14h00 \u00E0 17h30', colW[2]),
    ...
    const doc = new Document({
        sections: [{
            ...
            children: [
                ...
                new Paragraph({ spacing: { after: 60 }, children: [normal('Feuille de pr\u00E9sence - Date {{date}}', { size: 20 })] }),
                new Paragraph({ spacing: { after: 120 }, children: [normal('Lieu de la formation : {{training_location}}', { size: 20 })] }),
                table,
                new Paragraph({ spacing: { before: 200 }, children: [normal('J\'atteste avoir pris connaissance du r\u00E8glement int\u00E9rieur de NJM Conseil.', { size: 16 })] }),
            ],
        }],
    });
...
async function generateFichePeda() {
    ...
    function tblHeaderCell(text, width) {
        return new TableCell({
            width: { size: width, type: WidthType.DXA },
            borders: orangeBorder,
            shading: { fill: 'FFF8F0' },
            verticalAlign: VerticalAlign.CENTER,
            children: [new Paragraph({ children: [bold(text, { size: 15 })] })],
        });
    }
    function tblCell(text, width) {
        return new TableCell({
            width: { size: width, type: WidthType.DXA },
            borders: orangeBorder,
            verticalAlign: VerticalAlign.TOP,
            children: [new Paragraph({ children: [normal(text, { size: 14 })] })],
        });
    }
    ...
    const table = new Table({
        ...
        rows: [
            new TableRow({
                ...
                children: [
                    tblHeaderCell('Dur\u00E9e\n(en heures)', colW[0]),
                    tblHeaderCell('Objectifs p\u00E9dagogiques mesurables\n(aptitudes et comp\u00E9tences)', colW[1]),
                    tblHeaderCell('Contenu p\u00E9dagogique\npar module', colW[2]),
                    tblHeaderCell('M\u00E9thodes, moyens et outils\np\u00E9dagogiques', colW[3]),
                ],
            }),
            new TableRow({
                children: [
                    tblCell('{{duration}}h', colW[0]),
                    tblCell('{{objectives}}', colW[1]),
                    tblCell('{{content}}', colW[2]),
                    tblCell('{{methods}}', colW[3]),
                ],
            }),
        ],
    });
        ...
        sections: [{
            ...
            children: [
                ...
                new Paragraph({
                    ...
                    alignment: AlignmentType.CENTER,
                    children: [
                        bold('FICHE PEDAGOGIQUE : {{formation_name}}', { size: 22, underline: { type: UnderlineType.SINGLE } }),
                    ],
                }),
                new Paragraph({ spacing: { after: 40 }, children: [bold('Public : {{public}}')] }),
                new Paragraph({ spacing: { after: 100 }, children: [bold('Pr\u00E9 requis : {{prerequisites}}')] }),
                table,
                emptyLine(80),
                new Paragraph({ spacing: { after: 40 }, children: [bold('M\u00E9thodologie d\'\u00E9valuation : '), normal('{{evaluation}}')] }),
                new Paragraph({ spacing: { after: 40 }, children: [bold('Le + apport\u00E9 : '), normal('{{added_value}}')] }),
        ...
        sections: [
            // PAGE 1
            {
                ...
                children: [
                    ...
                    new Paragraph({ spacing: { after: 80 }, children: [bold('Entre les soussign\u00E9s :')] }),
                    new Paragraph({ spacing: { after: 40 }, children: [normal('1 \u2013 NJM Conseil, 1 Le Cassan 12330 Clairvaux d\'Aveyron, 534 935 473 000 15, organisme de formation enregistr\u00E9 sous le num\u00E9ro 73 12 00 635 12 aupr\u00E8s du Pr\u00E9fet de la r\u00E9gion Occitanie,')] }),
                    new Paragraph({ spacing: { after: 80 }, children: [normal('ci-apr\u00E8s \u00AB le donneur d\'ordre \u00BB')] }),

                    new Paragraph({ spacing: { after: 80 }, children: [bold('Et')] }),
                    new Paragraph({ spacing: { after: 40 }, children: [normal('2 \u2013 {{trainer_name}}, {{trainer_address}}, {{trainer_siret}}, organisme de formation enregistr\u00E9 sous le num\u00E9ro {{trainer_nda}} aupr\u00E8s du Pr\u00E9fet de la r\u00E9gion Occitanie,')] }),
                    new Paragraph({ spacing: { after: 80 }, children: [normal('ci-apr\u00E8s \u00AB le sous-traitant \u00BB')] }),

                    new Paragraph({ spacing: { after: 100 }, children: [normal('Il a \u00E9t\u00E9 convenu ce qui suit :')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article premier : Nature du contrat')] }),
                    new Paragraph({ spacing: { after: 60 }, children: [normal('Le pr\u00E9sent contrat est conclu dans le cadre d\'une prestation de formation ponctuelle r\u00E9alis\u00E9e par le sous-traitant au b\u00E9n\u00E9fice du donneur d\'ordre.')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 2 : Objet du contrat')] }),
                    new Paragraph({ spacing: { after: 20 }, children: [normal('La formation, objet du contrat, est la suivante : \u00AB {{formation_name}} \u00BB')] }),
                    new Paragraph({ spacing: { after: 20 }, children: [orangeBold('Date(s) : {{dates}}')] }),
                    new Paragraph({ spacing: { after: 60 }, children: [normal('Heures : {{duration}}h')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 3 : Dur\u00E9e du contrat')] }),
                    new Paragraph({ spacing: { after: 60 }, children: [normal('Le pr\u00E9sent contrat est strictement limit\u00E9 \u00E0 la prestation de formation vis\u00E9e \u00E0 l\'article 2. Il cesse de plein droit \u00E0 son terme.')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 4 : Obligations du sous-traitant')] }),
                    new Paragraph({ spacing: { after: 20 }, children: [normal('Le sous-traitant s\'engage \u00E0 :')] }),
            ...
            // PAGE 2
            {
                ...
                children: [
                    ...
                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 5 : Obligations du donneur d\'ordre')] }),
                    new Paragraph({ spacing: { after: 20 }, children: [normal('Le donneur d\'ordre s\'engage \u00E0 :')] }),
                    ...
                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 6 : Modalit\u00E9s financi\u00E8res')] }),
                    new Paragraph({ spacing: { after: 20 }, children: [normal('Le sous-traitant percevra une r\u00E9mun\u00E9ration de {{price}} euros nets par journ\u00E9e de formation (7 heures) et remboursement des frais d\'h\u00E9bergement, de restauration et de d\u00E9placement.')] }),
                    new Paragraph({ spacing: { after: 60 }, children: [normal('Le paiement sera effectu\u00E9 \u00E0 r\u00E9ception de la facture.')] }),

                    new Paragraph({ spacing: { after: 40 }, children: [bold('Article 7 : Dispositions diverses')] }),
                    ...
                    new Paragraph({ spacing: { after: 200 }, children: [normal('Fait \u00E0 Cassan, le {{signature_date}}')] }),
                    new Paragraph({
                        spacing: { after: 40 },
                        tabStops: [{ type: TabStopType.LEFT, position: convertMillimetersToTwip(100) }],
                        children: [
